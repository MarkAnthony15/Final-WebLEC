                        ...
                        <form action="Login" method="Post">
                            <div class="col-xs-10 col-sm-10 col-md-10">
                                ...
                                <div class="form-group">
                                    <input type="email" name="logemail" id="email" class="form-control input-sm" placeholder="Email Address">
                                </div>
                            </div>
                            <div class="col-xs-10 col-sm-10 col-md-10">
                                <label>Password</label>
                                <div class="form-group">
                                    <input type="password" name="logpassword" id="password" class="form-control input-sm" placeholder="Password">
                                </div>
                            </div>
                            <div class="col-xs-10 col-sm-10 col-md-10">
                                <div class="form-group">
