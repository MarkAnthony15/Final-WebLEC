...
<div class="container">
            ...
            <div class="panel panel-default">
                  <div class="panel-heading text-center">
                    ...
                    <div class="panel-body">
                        <form role="form" action="./questionReply.php" method="POST">
                          <label>Alias</label>
                          ...
                          <label>Title</label>
                          <div class="form-group">
                            <input type="text" name="title" id="title" class="form-control input-sm" placeholder="Title of the question and author.">
                          </div>
                          <div class="form-group">
    ...
    <footer>
        <p>Copyright ©<a style="color:#0a93a6; text-decoration:none;" href="http://localhost:8080/test/index.jsp"> Made To Educate</a>. All rights reserved 2018-2019.</p>
    </footer>
</body>
</html>